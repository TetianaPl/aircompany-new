...
public class ExperimentalPlane extends Plane {
    ...
    public ExperimentalPlane(String model, int speed, int flightDistance, int loadCapacity,
                             ExperimentalTypes experimentalType, ClassificationLevels classificationLevel) {
    ...
    public String toString() {
        return "\nExperimental plane "
            ...
            ", experimental type = " + experimentalType + ", classification level = " + classificationLevel + "}");
    }
