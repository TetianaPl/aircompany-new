...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Airport militaryAirport = new Airport(airport.getPlanesByType(MilitaryPlane.class));
        Airport passengerAirport = new Airport(airport.getPlanesByType(PassengerPlane.class));
        System.out.println("Military planes sorted by max distance: " + militaryAirport
                .sortByFlightDistance()
                .toString());
        System.out.println("\nPassenger planes sorted by max speed: " + passengerAirport
                .sortBySpeed()
                .toString());

        System.out.println("\nPlane with max passenger capacity: " + passengerAirport.findPlaneWithMaxPassengerCapacity());
    }
}
